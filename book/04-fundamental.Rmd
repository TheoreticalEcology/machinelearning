...
```
```{r chunk_chapter4_task_26, message=FALSE, warning=FALSE, echo=FALSE}
...
```{r chunk_chapter4_task_29, message=FALSE, warning=FALSE, echo=FALSE}
...
```{r chunk_chapter4_34, echo=FALSE}
knitr::include_graphics("./images/svm.gif")
```

As you have seen this does not work with every kernel. Thus, the problem is to find the actual correct kernel, which is again an optimization procedure and can thus be approximated.
