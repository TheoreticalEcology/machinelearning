...
```{r chunk_chapter2_12, eval=FALSE}
...
```{=html}
  ...
  <ul>
    ...
    <li>Change the first line of the function to &quot;function(x = 3)&quot; and try out the following commands: &quot;squareValue(2)&quot;, &quot;squareValue()&quot; - What is the sense of this syntax?</li>
    <li>Modify the function to multiply 2 values. Hint - this should start with &quot;function(x1, x2)&quot;.</li>
  </ul>
```
...
```{=html}
  ...
  <ul>
    ...
    <li>Why is the first result of apply NA? Check the help of mean to understand this.</li>
