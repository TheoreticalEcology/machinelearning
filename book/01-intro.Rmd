...
```{r iris plot, fig.width=10, fig.height=4}
colors = hcl.colors(3)
...
Unlike tenosrflow, torch doesn't have two data containers for mutable and immutable variables. All variables are initialized via the torch_tensor function:
