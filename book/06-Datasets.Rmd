# Datasets
You can download the datasets we use in the course [here](http://rhsbio7.uni-regensburg.de:8500) (ignore browser warnings)
...
model %>% 
  compile(optimizer = optimizer_adamax(0.01), loss = loss_categorical_crossentropy)
