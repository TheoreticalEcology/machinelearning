...
```{r chunk_chapter6_13, eval=FALSE}
write.csv(data.frame(y = preds), file = "glm.csv")
```
...
```{r chunk_chapter6_25, eval=FALSE}
write.csv(data.frame(y = preds), file = "rf.csv")
```
...
```{r chunk_chapter6_28, eval=FALSE}
...
```{r chunk_chapter6_29, eval=FALSE}
...
```{r chunk_chapter6_30, eval=FALSE}
