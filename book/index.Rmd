...
We may sometimes use datasets from the EcoData package. To install the package, run:
...
We will make huge use of different libraries. So take a coffee or 2 and install the following libraries:
