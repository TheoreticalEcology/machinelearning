...
```
<br/>
```{r chunk_chapter3_task_0, message=FALSE, warning=FALSE, include=FALSE}
library(dendextend)
...
```
<br/>
```{r chunk_chapter3_task_1, include=FALSE}
do_clustering = function(traits, scale = FALSE){
  set.seed(123)
...
```
<br/>
```{r chunk_chapter3_task_2, message=FALSE, warning=FALSE, include=FALSE}
library(dbscan)
...
```
<br/>
```{r chunk_chapter3_task_3, message=FALSE, warning=FALSE, include=FALSE}
library(mclust)
...
```
<br/>
```{r chunk_chapter3_task_4, message=FALSE, warning=FALSE, include=FALSE}
traits = as.matrix(iris[,1:4])
