...
```{r chunk_chapter4_task_1_torch, cache=TRUE, message=FALSE, warning=FALSE}
...
```{r chunk_chapter4_task_3_torch, cache=TRUE, message=FALSE, warning=FALSE}
library(torch)
torch_manual_seed(321L)
set.seed(123)
...
```{r chunk_chapter4_task_3_torch_msg, message=FALSE, warning=FALSE, echo=FALSE}
cat("Linear:     ", round(coef(linear), 3))
cat("L1:         ", round(c(as.numeric( l1_torch$`0.bias` ),as.numeric( l1_torch$`0.weight` )), 3))
...
```{r chunk_chapter4_task_5_torch, cache=TRUE, message=FALSE, warning=FALSE}
library(torch)
torch_manual_seed(321L)
set.seed(123)
...
```{r chunk_chapter4_task_5_torch_msg, message=FALSE, warning=FALSE, echo=FALSE}
cat("Linear:     ", round(coef(linear), 3))
cat("L1:         ", round(c(as.numeric( l1_torch$`0.bias` ),as.numeric( l1_torch$`0.weight` )), 3))
...
```{r chunk_chapter4_task_6_torch, cache=TRUE, message=FALSE, warning=FALSE}
library(torch)
torch_manual_seed(321L)
set.seed(123)
...
```{r chunk_chapter4_task_6_torch_msg, message=FALSE, warning=FALSE, echo=FALSE}
cat("Linear:     ", round(coef(linear), 3))
cat("L2:         ", round(c(as.numeric( l2_torch$`0.bias` ),as.numeric( l2_torch$`0.weight` )), 3))
...
```{r chunk_chapter4_task_10_torch, cache=TRUE, message=FALSE, warning=FALSE}
library(torch)
torch_manual_seed(321L)
set.seed(123)
...
```{r chunk_chapter4_task_10_torch_msg, message=FALSE, warning=FALSE, echo=FALSE}
cat("Linear:     ", round(coef(linear), 3))
cat("L1:         ", round(c(as.numeric( l1_torch$`0.bias` ),as.numeric( l1_torch$`0.weight` )), 3))
cat("L1 lesser:         ", round(c(as.numeric( l1_torch_lesser$`0.bias` ),as.numeric( l1_torch_lesser$`0.weight` )), 3))
...
```{r chunk_chapter4_task_11_torch, cache=TRUE, message=FALSE, warning=FALSE}
library(torch)
torch_manual_seed(321L)
set.seed(123)
...
```{r chunk_chapter4_task_11_torch_msg, message=FALSE, warning=FALSE, echo=FALSE}
cat("Linear:     ", round(coef(linear), 3))
cat("L2:         ", round(c(as.numeric( l2_torch$`0.bias` ),as.numeric( l2_torch$`0.weight` )), 3))
cat("L2 lesser:         ", round(c(as.numeric( l2_torch_lesser$`0.bias` ),as.numeric( l2_torch_lesser$`0.weight` )), 3))
...
```{r chunk_chapter4_task_13_torch, cache=TRUE, message=FALSE, warning=FALSE}
library(torch)
torch_manual_seed(321L)
set.seed(123)
...
```{r chunk_chapter4_task_15_cito, cache=TRUE, message=FALSE, warning=FALSE}
# devtools::install_github("citoverse/cito")
library(cito)
...
```{r chunk_chapter4_task_16_cito, cache=TRUE, message=FALSE, warning=FALSE}
# devtools::install_github("citoverse/cito")
library(cito)
...
```{r chunk_chapter4_task_17_cito, cache=TRUE, message=FALSE, warning=FALSE}
# devtools::install_github("citoverse/cito")
library(cito)
...
```{r chunk_chapter4_task_18_cito, cache=TRUE, message=FALSE, warning=FALSE}
# devtools::install_github("citoverse/cito")
library(cito)
...
```{r chunk_chapter4_task_19_cito, cache=TRUE, message=FALSE, warning=FALSE}
# devtools::install_github("citoverse/cito")
library(cito)
...
```{r chunk_chapter4_task_20_cito, cache=TRUE, message=FALSE, warning=FALSE}
# devtools::install_github("citoverse/cito")
library(cito)
