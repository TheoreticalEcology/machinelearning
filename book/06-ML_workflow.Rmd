...
```{r chunk_chapter4_task_41, message=FALSE, warning=FALSE, include=FALSE}
...
```{r chunk_chapter4_task_41_torch, include=FALSE}
library(torch)
...
```{r chunk_chapter4_task_41_cito, message=FALSE, warning=FALSE, include=FALSE}
library(cito)
...
```{r chunk_chapter4_task_42, message=FALSE, warning=FALSE, include=FALSE}
set_random_seed(4321L, disable_gpu = FALSE)	# Already sets R's random seed.
...
```{r chunk_chapter4_task_42_torch, include=FALSE}
library(torch)
...
```{r chunk_chapter4_task_42_cito, message=FALSE, warning=FALSE, include=FALSE}
library(cito)
...
```{r chunk_chapter4_task_43, message=FALSE, warning=FALSE, include=FALSE}
...
```{r chunk_chapter4_task_43_torch, include=FALSE}
library(torch)
...
```{r chunk_chapter4_task_43_cito, message=FALSE, warning=FALSE, include=FALSE}
library(cito)
