...
The idea is that all the convolutional layer have mainly one task - learning to identify highly correlated neighbored features and therefore to learn structures such as edges in the image.
