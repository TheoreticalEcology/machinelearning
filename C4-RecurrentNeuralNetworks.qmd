...
<!-- net = nn_module( -->
<!--   initialize = function() { -->
<!--     self$encoder = nn_lstm(input_size = 21L, hidden_size = 50L ,batch_first = TRUE) -->
<!--     self$decoder = nn_lstm(input_size = 21L, hidden_size = 50L ,batch_first = TRUE) -->
<!--     self$linear = nn_linear(50,  1L) -->
<!--     self$projection = nn_linear(50, 21) -->
<!--   },  -->
<!--   forward = function(x, n_steps = 6L) { -->
<!--     xx = self$encoder(x) -->
<!--     hidden_decoder = xx[[2]] # [] -->
<!--     input_t = x[,dim(x)[2],,drop=F] # last time step -->

<!--     outputs = list() -->
<!--     for(n in 1:n_steps) { -->
<!--       x = self$decoder(input_t, hidden_decoder) -->
<!--       output_sequence = x[[1]] -->
<!--       hidden_decoder = x[[2]] -->
<!--       pred = self$linear(output_sequence |> nnf_relu() )$squeeze(2) -->
<!--       step_pred = self$projection(output_sequence |> nnf_relu() )$squeeze(2) -->
<!--       outputs = c(outputs, pred) -->
<!--       input_t = step_pred$unsqueeze(2) -->
<!--     } -->
<!--     return(torch_cat(outputs,2)) -->
<!--   } -->
<!-- ) -->
...
<!-- model$eval() -->
<!-- preds = as.matrix(model$forward(torch_tensor(X_test)[1,,,drop=F], n_steps = 6*300 )) -->

<!-- preds = matrix(preds[1,], 300, 6, byrow = T) -->

<!-- matplot(cbind(as.vector(preds[,]),   -->
<!--               as.vector(Y_test[,])),  -->
<!--         col = c("darkblue", "darkred"), -->
<!--         type = "l",  -->
<!--         pch = c(15, 16), -->
