...
:::: exercise
#### Tune random forest (Plant-pollinator)
...
Using the plant-pollinator dataset (see @sec-plantpoll), we want to optimize nodesize, max depth, and mtry in our RF using a simple CV. The task is to predict whether a plant and a pollinator interact, based on their traits.
