...
model = keras_model_sequential(shape(80L, 80L, 3L))
model |>
  layer_conv_2d(filter = 16L, kernel_size = c(5L, 5L), activation = "relu") |>
  layer_max_pooling_2d() |>
...
# Data augmentation.
aug = keras::image_data_generator(rotation_range = 90, 
                           zoom_range = c(0.3), 
...
generator = keras::flow_images_from_data(train[-indices,,,],
...
early = keras3::callback_early_stopping(patience = 2L, monitor = "loss")
