...
::: exercise
#### Synthesis: compare the model families

Over the tree and neural-network chapters you have fit a random forest, a boosted regression tree, and a deep neural network to the **same** titanic data. Collect the cross-validated AUCs you obtained for each method and put them side by side.

- Which model family performed best on this data set, and by how much?
- Was the difference large enough to matter, or are the methods roughly comparable here?
- Titanic is a small, low-dimensional, tabular data set. Which of these methods would you expect to benefit most from much larger or higher-dimensional data?

There is no single correct answer here — the point is to connect the methods you have learned and to build a sense of when each one is worth reaching for.
:::
