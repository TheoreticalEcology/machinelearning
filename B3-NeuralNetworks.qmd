...
```{r, fig.cap="Training curve for a well-chosen learning rate: the loss decreases smoothly and levels off."}
data = airquality[complete.cases(airquality),] # DNN cannot handle NAs!
data = scale(data)
...
```{r, fig.cap="Weights of the first layer. Watch out that regularization does not shrink all of them to zero."}
